...
public class SearchViewModel extends AndroidViewModel implements UserListCallback {
    ...
    public void userListCallback(UserCallbackType type, List<UserModel> users, int count, int offset, int totalSize) {
        if(type == UserCallbackType.USER_LOCATION_SEARCH) {
            ...
            if(isInNameSearch) {
                ...
                // TODO - Potential problem is the page 0 is reloaded. The other pages may be flush by accident...
                if(offset == 0) {
